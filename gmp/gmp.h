...
#define __GMP_CC " /c/temp/gcc_2nd_try/./prev-gcc/xgcc -B/c/temp/gcc_2nd_try/./prev-gcc/ -B/usr/local/i686-pc-mingw32/bin/ -L/c/temp/gcc_2nd_try/i686-pc-mingw32/winsup/mingw -L/c/temp/gcc_2nd_try/i686-pc-mingw32/winsup/w32api/lib -isystem /c/temp/gcc-4.7.0/winsup/mingw/include -isystem /c/temp/gcc-4.7.0/winsup/w32api/include -B/usr/local/i686-pc-mingw32/bin/ -B/usr/local/i686-pc-mingw32/lib/ -isystem /usr/local/i686-pc-mingw32/include -isystem /usr/local/i686-pc-mingw32/sys-include    -std=gnu99"
#define __GMP_CFLAGS "-g -O2 -D__USE_MINGW_ACCESS -Wno-pedantic-ms-format"
