...
#line 24 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 29 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(FP_REGNO_P (REGNO (op))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (!(
#line 34 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(ANY_FP_REGNO_P (REGNO (op)))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (!(
#line 39 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(FP_REGNO_P (REGNO (op)))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 44 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 49 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
#line 54 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
...
#line 63 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
...
{
  return ((GET_CODE (op) == REG) && (
#line 78 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(REGNO (op) == AX_REG))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && (
#line 83 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(REGNO (op) == FLAGS_REG))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return (
#line 87 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(QI_REG_P (op))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
{
  return ((GET_CODE (op) == REG) && ((
#line 93 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(TARGET_64BIT)) && (
#line 94 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(REGNO (op) > BX_REG)))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
#line 99 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
{
  return (
#line 113 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 119 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
#line 126 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  if (!TARGET_64BIT)
...
#line 253 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case CONST_DOUBLE:
...
{
  return (
#line 338 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 346 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 354 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 361 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
#line 371 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  if (!flag_pic)
    return false;
...
#line 399 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case SYMBOL_REF:
...
#line 443 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
...
{
  return (!(
#line 482 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
#line 488 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == SYMBOL_REF) && (
#line 492 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
#line 497 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
...
#line 511 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 525 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 538 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
{
  return (
#line 561 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
#line 569 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
#line 580 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  if (mode == VOIDmode)
    mode = GET_MODE (op);
...
#line 589 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(op == const1_rtx));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 594 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(INTVAL (op) == 8));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 599 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(INTVAL (op) == 128));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 604 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
#line 610 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
...
#line 618 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
...
#line 626 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 3 || i == 5 || i == 9;
}
...
{
  return (GET_CODE (op) == CONST_INT) && ((
#line 634 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(op == const0_rtx)) || (
#line 635 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(op == const1_rtx)));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 640 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 645 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 650 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 655 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 660 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 679 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 685 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 690 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 695 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 700 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 705 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 710 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 715 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(IN_RANGE (INTVAL (op), 12, 15)));
}

static inline int
incdec_operand_1 (rtx op, enum machine_mode mode ATTRIBUTE_UNUSED)
#line 720 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
...
#line 732 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(op == const1_rtx)) || (
#line 733 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
(op == constm1_rtx))));
}
...
{
  return (
#line 737 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return (
#line 742 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
#line 750 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  unsigned n_elts;
...
#line 771 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
...
#line 798 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
...
#line 816 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
...
#line 834 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
  rtx disp;
...
#line 869 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 930 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 942 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 962 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1033 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
#line 1048 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  enum machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
#line 1085 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  enum machine_mode inmode = GET_MODE (XEXP (op, 0));
  enum rtx_code code = GET_CODE (op);
...
{
  return (
#line 1111 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
#line 1119 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  enum rtx_code code = GET_CODE (op);
  bool ret;
...
#line 1169 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == MEM) && (
#line 1180 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
...
#line 1185 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
  unsigned i;
...
#line 1215 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
...
#line 1240 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
...
#line 1255 "../../gcc-4.7.0/gcc/config/i386/predicates.md"
{
